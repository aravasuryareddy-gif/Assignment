...
console.log("Post Increament:   " + (a++));
console.log("After next line of post increament:   " + (++a));
console.log("post decreament:   " + (a--));
console.log("After next line of post decreament:   " + (--a));
console.log("Pre decreament:  "+(--b));
console.log("Post Decreament:  "+(b--));
...
c -=5; //c =c -5
console.log("Substraction Assignment:  "+ c);
c *=2; //c = C *2
console.log("Multiplication Assignment: "+c);
c /=5; // c=c /5
console.log("Divisional Assignment:  "+c);
c %=3; // c =c % 3
console.log("Modulus Assigment:  "+c);
